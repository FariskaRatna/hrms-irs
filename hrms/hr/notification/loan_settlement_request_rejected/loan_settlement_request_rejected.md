<h3>Loan Settlement Application {{ doc.name }} Rejected by HR Manager</h3>

<p>
The loan settlement request <strong>{{ doc.name }}</strong> has been rejected by the HR Manager.
